...
export class DepartmentService {
     ...
     * @return void
     */
    async createDepartment(repositoryType, department) {
     ...
     */
    async getDepartments(repositoryType) {
        switch (repositoryType) {
            case RepositoryType.MongoDB:
     ...
     */
    async getDepartment(repositoryType, id) {
        switch (repositoryType) {
            case RepositoryType.MongoDB:
     ...
     * @returns void
     */
    async updateDepartment(repositoryType, department) {
        switch (repositoryType) {
            case RepositoryType.MongoDB:
     ...
     * @returns void
     */
    async deleteDepartment(repositoryType, id) {
        switch (repositoryType) {
            case RepositoryType.MongoDB:
     ...
     * @returns void
     */
    async transferEmployees(repositoryType, sourceDepartmentId, targetDepartmentId, employeeIds) {
        switch (repositoryType) {
            case RepositoryType.MongoDB:
            ...
            case RepositoryType.PostgreSQL:
            default:
                await this.postgreSQLDepartmentRepository.transferEmployees(sourceDepartmentId, targetDepartmentId, employeeIds);
                break;
        }
    }
}
